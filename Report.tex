...
\begin{IEEEkeywords}
Approximate Inference, Variational Inference, Deep Learning, Generative Model, Auto Encoder.
\end{IEEEkeywords}
...
\begin{figure}[!htb]\centering
   ...
   \begin {minipage}{0.245\textwidth}
     ...
     \caption{Models with v-structure and edge between latent variables: The posterior distribution are intractable because of the interaction between latent variables\cite{Goodfellow-et-al-2016}}\label{pic_2}
   \end{minipage}
\end{figure}
